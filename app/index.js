...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Canvas)\n/* harmony export */ });\n/* harmony import */ var _shared_main_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../shared/main.js */ \"./scripts/shared/main.js\");\n\r\n\r\n\r\nconst toolsId = [\r\n    'pen', 'pen2',\r\n    'rectangle', 'round-rectangle',\r\n    'circle', 'ellipse',\r\n    'line', 'arc-to',\r\n    'bezier', 'quadratic',\r\n    'add-layer',\r\n    'clipboard',\r\n    'eraser', 'fillrule',\r\n    'nomove'\r\n]\r\n\r\nconst previousPosition = { x: null, y: null };\r\n\r\nclass Canvas {\r\n    constructor(id, rootElem, layerElem) {\r\n        const { width, height } = rootElem.getBoundingClientRect();\r\n        const { width: lWidth, height: lHeight } = layerElem.getBoundingClientRect();\r\n\r\n        this.canvas = document.createElement('canvas');\r\n        this.layerCanvas = this.canvas.cloneNode();\r\n        this.canvas.dataset.id = id.unique;\r\n\r\n        rootElem.appendChild(this.canvas);\r\n        layerElem.appendChild(this.layerCanvas);\r\n\r\n        this.layer = layerElem;\r\n\r\n        this.ctx = this.canvas.getContext('2d');\r\n        this.lctx = this.layerCanvas.getContext('2d');\r\n\r\n\r\n        this.canvas.width = width;\r\n        this.canvas.height = height;\r\n        this.layerCanvas.width = lWidth;\r\n        this.layerCanvas.height = lHeight;\r\n\r\n        const span = document.createElement('span');\r\n        span.innerText = `Layer ${id.name}`;\r\n\r\n        layerElem.appendChild(span);\r\n        this.id = id.unique;\r\n        this.name = id.name;\r\n        this.isDrawing = false;\r\n        this.#eventlistener();\r\n    }\r\n\r\n    #eventlistener() {\r\n        this.canvas.addEventListener('mousedown', (e) => {\r\n            const rect = this.canvas.getBoundingClientRect();\r\n            const x = e.clientX - rect.left;\r\n            const y = e.clientY - rect.top;\r\n\r\n            this.ctx.lineCap = 'round';\r\n            this.ctx.lineJoin = 'round';\r\n            this.ctx.beginPath();\r\n            this.ctx.moveTo(x, y);\r\n            this.isDrawing = true;\r\n        });\r\n\r\n        this.canvas.addEventListener('mousemove', (e) => {\r\n            if (this.isDrawing) {\r\n                const rect = this.canvas.getBoundingClientRect();\r\n                const x = e.clientX - rect.left;\r\n                const y = e.clientY - rect.top;\r\n\r\n                this.draw(x, y);\r\n\r\n                this.lctx.drawImage(this.canvas, 0, 0, this.layerCanvas.width, this.layerCanvas.height)\r\n            }\r\n        });\r\n\r\n        this.canvas.addEventListener('mouseup', () => {\r\n            this.isDrawing = false;\r\n        });\r\n    }\r\n\r\n    draw(x, y) {\r\n        switch (_shared_main_js__WEBPACK_IMPORTED_MODULE_0__.tools.selectedTool) {\r\n            case 'pen':\r\n                this.#pen(x, y);\r\n                break;\r\n            case 'pen2':\r\n                this.#brush(x, y);\r\n                break;\r\n            case 'rectangle':\r\n                this.#rectangle(x, y);\r\n                break;\r\n            case 'round-rectangle':\r\n                this.#roundRectangle(x, y);\r\n                break;\r\n            case 'circle':\r\n                this.#circle(x, y);\r\n                break;\r\n            case 'ellipse':\r\n                this.#ellipse(x, y);\r\n                break;\r\n            case 'line':\r\n                this.#line(x, y);\r\n                break;\r\n            case 'arc-to':\r\n                this.#arcTo(x, y);\r\n                break;\r\n            case 'bezier':\r\n                this.#bezier(x, y);\r\n                break;\r\n            case 'quadratic':\r\n                this.#quadratic(x, y);\r\n                break;\r\n            case 'eraser':\r\n                this.#eraser(x, y);\r\n                break;\r\n            default:\r\n                this.#pen(x, y);\r\n                break;\r\n        }\r\n\r\n        if (previousPosition.x !== null && previousPosition.y !== null) {\r\n            previousPosition.x = x;\r\n            previousPosition.y = y;\r\n        }\r\n    }\r\n\r\n    #pen(x, y) {\r\n        this.ctx.lineTo(x, y);\r\n        this.ctx.stroke();\r\n    }\r\n\r\n    #brush(x, y) {\r\n        const distX = x - previousPosition.x;\r\n        const distY = y - previousPosition.y;\r\n        const distance = Math.sqrt(distX * distX + distY * distY);\r\n        const angle = Math.atan2(distY, distX);\r\n        const step = 1;\r\n\r\n        for (let i = 0; i < distance; i += step) {\r\n            const offsetX = previousPosition.x + Math.cos(angle) * i;\r\n            const offsetY = previousPosition.y + Math.sin(angle) * i;\r\n            this.ctx.lineTo(offsetX, offsetY);\r\n        }\r\n        this.ctx.stroke();\r\n    }\r\n\r\n    #rectangle(x, y) {\r\n        this.ctx.rect(previousPosition.x, previousPosition.y, x - previousPosition.x, y - previousPosition.y);\r\n        this.ctx.stroke();\r\n    }\r\n\r\n    #roundRectangle(x, y) {\r\n        this.ctx.roundRect(previousPosition.x, previousPosition.y, x - previousPosition.x, y - previousPosition.y, 10);\r\n        this.ctx.stroke();\r\n    }\r\n\r\n    #circle(x, y) {\r\n        const radius = Math.sqrt(Math.pow((x - previousPosition.x), 2) + Math.pow((y - previousPosition.y), 2));\r\n        this.ctx.arc(previousPosition.x, previousPosition.y, radius, 0, Math.PI * 2);\r\n        this.ctx.stroke();\r\n    }\r\n    #ellipse(x, y) {\r\n        const radiusX = Math.abs(x - previousPosition.x);\r\n        const radiusY = Math.abs(y - previousPosition.y);\r\n        this.ctx.ellipse(previousPosition.x, previousPosition.y, radiusX, radiusY, 0, 0, Math.PI * 2);\r\n        this.ctx.stroke();\r\n    }\r\n\r\n    #line(x, y) {\r\n        this.ctx.lineTo(x - previousPosition.x, y - previousPosition.y);\r\n        this.ctx.stroke();\r\n    }\r\n\r\n    #arcTo(x, y) {\r\n        this.ctx.arcTo(previousPosition.x, previousPosition.y, x, y, 50);\r\n        this.ctx.stroke();\r\n    }\r\n    #bezier(x, y) {\r\n        this.ctx.bezierCurveTo(previousPosition.x, previousPosition.y, x, y, x, y);\r\n        this.ctx.stroke();\r\n    }\r\n    #quadratic(x, y) {\r\n        this.ctx.quadraticCurveTo(previousPosition.x, previousPosition.y, x, y);\r\n        this.ctx.stroke();\r\n    }\r\n\r\n\r\n    #eraser(x, y) {\r\n        this.ctx.globalCompositeOperation = 'destination-out';\r\n        this.#pen(x, y);\r\n        this.ctx.globalCompositeOperation = 'source-over';\r\n    }\r\n\r\n    clear() {\r\n        this.ctx.clearRect(0, 0, this.canvas.width, this.canvas.height);\r\n    }\r\n\r\n    destroy() {\r\n\r\n    }\r\n}\n\n//# sourceURL=webpack://quanvas/./scripts/core/canvas.js?\n}");
